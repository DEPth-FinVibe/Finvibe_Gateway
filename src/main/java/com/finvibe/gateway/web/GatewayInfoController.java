...
public class GatewayInfoController {
    ...
    private final String websocketListenerUrl;
    ...
    public GatewayInfoController(
        ...
        this.websocketListenerUrl = websocketListenerUrl;
    ...
    public Map<String, Object> info() {
        return Map.of(
                ...
                "routes", List.of(
                        Map.of("id", "websocketListener", "path", "/api/market/ws/**", "target", websocketListenerUrl),
